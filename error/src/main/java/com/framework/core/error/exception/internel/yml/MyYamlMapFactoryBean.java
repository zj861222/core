...
package com.framework.core.error.exception.internel.yml;
 ...
 * @since 4.1
 */
public class MyYamlMapFactoryBean extends YamlProcessor implements FactoryBean<Map<String, Object>>, InitializingBean {
